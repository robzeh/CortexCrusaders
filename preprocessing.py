...
#        task_1 = tasks[i]
#        task_2 = tasks[j]
#        min_length = min(len(trimmed_mean_values[task_1]), len(trimmed_mean_values[task_2]))
#        t_statistic, p_value = ttest_ind(trimmed_mean_values[task_1][:min_length], 
#                                          trimmed_mean_values[task_2][:min_length], 
